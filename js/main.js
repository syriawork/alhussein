...
const translations = {
    ...
    testimonialAuthor1: { ar: '- أحمد محمد', en: '- Ahmed Mohamed' },
    ...
    contactAddressLine1: { ar: 'الرياض، حي الملك فهد', en: 'Riyadh, Al Malaz district' },
    ...
    contactPhoneLine1: { ar: '+966 50 123 4567', en: '+966 50 123 4567' },
    ...
    faqA2: { ar: 'الشحن مجاني للطلبات فوق 500 ريال. للطلبات الأقل، تكلفة الشحن 50 ريال داخل الرياض و100 ريال خارجها.', en: 'Shipping is free for orders over 500 SAR. For smaller orders, shipping costs 50 SAR inside Riyadh and 100 SAR outside.' },
    ...
    faqA4: { ar: 'التوصيل يستغرق 2-3 أيام عمل داخل الرياض و4-5 أيام عمل خارجها.', en: 'Delivery takes 2-3 business days within Riyadh and 4-5 business days outside.' },
    ...
    footerContactPhone: { ar: 'الهاتف: +966 50 123 4567', en: 'Phone: +966 50 123 4567' },
    footerContactEmail: { ar: 'البريد: info@alhussein.com', en: 'Email: info@alhussein.com' },
    footerContactAddress: { ar: 'العنوان: الرياض، المملكة العربية السعودية', en: 'Address: Riyadh, Saudi Arabia' },
