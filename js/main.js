...
const translations = {
    ...
    faqA2: { ar: 'الشحن مجاني للطلبات فوق 500000 ليرة سورية. للطلبات الأقل، تكلفة الشحن 50000 ليرة سورية داخل حلب و100000 ليرة سورية خارجها.', en: 'Shipping is free for orders over 500,000 SYP. For smaller orders, shipping costs 50,000 SYP inside Aleppo and 100,000 SYP outside.' },
    ...
    faqA4: { ar: 'التوصيل يستغرق 2-3 أيام عمل داخل حلب و4-5 أيام عمل خارجها.', en: 'Delivery takes 2-3 business days within Aleppo and 4-5 business days outside.' },
    ...
    footerContactAddress: { ar: 'العنوان: سوريا - حلب - باب انطاكيه', en: 'Address: Syria - Aleppo - Bab Antakia' },
    ...
    addedToCartMessage: { ar: 'تم إضافة {productName} إلى السلة بنجاح!', en: '{productName} has been added to your cart!' },
    addedToCartConfirmation: { ar: 'تمت الإضافة ✓', en: 'Added ✓' }
};
